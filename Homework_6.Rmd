...
qplot(rgamma(n=1004,shape=4.83402,rate=0.4463983),color=I("black"),fill=I("goldenrod"))
# make a formal ggplot call, then can stack
# change transparency...caallled alpha
...
qplot(rnorm(n=1004,mean=10.8289333,sd=4.5714441),color=I("black"),fill=I("goldenrod"))


#  scale = 1/rate
# if study is small, can increase n
...
# qplot(nbiRan,color=I("black"),fill=I("goldenrod"))
# I think mu=mean, n was returned in the results above, size returns NA
...
Pretty close
Not sure about the upper limit outlier
I am going to try the same with the normal
