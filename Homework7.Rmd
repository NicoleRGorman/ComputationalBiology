...
<br>
*The typical sample size for analysis of root length phenotypes is n = 10 plants/genotype/treatment. For this dataset, there are 3 independent biological replicates. For this particular dataset, the data need to be reformatted, so only the first replicate is included with this analysis to help simplify. In the future, data will be formatted differently to simplify downstream analyses.*
